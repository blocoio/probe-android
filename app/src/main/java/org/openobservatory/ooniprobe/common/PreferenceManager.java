...
public class PreferenceManager {
    ...
    static final String IS_NOTIFICATION_DIALOG = "isNotificationDialog";
    ...
    public boolean isTestRiseupVPN() {
		return sp.getBoolean(r.getString(R.string.test_riseupvpn), true);
    }
    ...
    public boolean canCallDeleteJson() {
		...
		return System.currentTimeMillis() - lastCalled > DELETE_JSON_DELAY;
	}
